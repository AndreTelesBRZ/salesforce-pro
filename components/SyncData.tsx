...
import { CloudDownload, RefreshCw, Package, Users, CheckCircle, AlertCircle, ArrowLeft, Database } from 'lucide-react';
    ...
    <div className="p-4 max-w-2xl mx-auto pb-20">
       <div className="flex items-center gap-3 mb-6">
           ...
           <h2 className="text-xl font-bold text-slate-800 dark:text-white flex items-center gap-2">
             <CloudDownload className="w-6 h-6 text-purple-600" /> Sincronização de Dados
           </h2>
       </div>
